...
import com.iexec.resultproxy.jwt.Jwt;
...
public class AuthorizationService {
    ...
    AuthorizationService(Eip712ChallengeService challengeService, JwtService jwtService) {
    ...
    public String getOrCreateJwt(String signedChallenge) {
        ...
        String jwtString ;
        Optional<Jwt> oExistingJwt = jwtService.findByWalletAddress(auth.getWalletAddress());
        ...
        if (oExistingJwt.isPresent()){
            ...
            jwtString = Jwts.builder()
                    ...
                    .compact();
            jwtService.save(new Jwt(auth.getWalletAddress(), jwtString));
        }
    ...
    public boolean isValidJwt(String jwtString) {
        ...
        Optional<Jwt> oExistingJwt = jwtService.findByWalletAddress(claimedWalletAddress);
