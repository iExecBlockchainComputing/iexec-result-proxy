...
| `IEXEC_CHAIN_ID` | Chain ID of the blockchain network to connect. | `Integer | `421614` |
...
| `IEXEC_BLOCKCHAIN_NODE_ADDRESS` | Private URL to connect to the blockchain node. | URL | `https://sepolia-rollup.arbitrum.io/rpc` |
...
| `IEXEC_GAS_PRICE_MULTIPLIER` | Transactions will be sent with `networkGasPrice * IEXEC_GAS_PRICE_MULTIPLIER`. | Float | `1.1` |
